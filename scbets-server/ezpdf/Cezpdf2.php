    ...
    public function __construct($paper='a4',$orientation='portrait', $type = 'none', $options = array()){
        ...
        switch ($type) {
            ...
            case 'image'  :
                ...
                $this->ezBackground['repeat'] = false;
        ...
        if($this->ezPageCount ==1){
               switch ($this->ezBackground['format']) {
                   case IMAGETYPE_JPEG:
                       ...
                       //$this->addJpegFromFile($this->ezBackground['image'], 150, 250,300, 300);
                       $this->addJpegFromFile($this->ezBackground['image'], 150, 250, 300);
