 ...
 class Cpdf
{
    ...
    private $fontFamilies = array(
            ...
            'SoberanaTitular' => array(
                    'b'=>'SoberanaTitular-Bold',
                )
    );
    ...
    protected function openFont($font) {
        ...
        //echo "buscando ttf1:".$fullFontPath.".ttf";
        ...
        if (file_exists($this->tempPath.'/'.$cachedFile)) {
            ...
            //Lo quite porque estos servers no puden crear fuentes solo puede crear fuentes el web1 de dgeta
