...
<div class="email-app todo-box-container">
    ...
    <div class="left-part list-of-tasks">
        ...
        <div class="scrollable" style="height: 100%">
            <div class="p-3">
                <a class="waves-effect waves-light btn btn-info d-block" enable href="javascript: void(0)">PRESTAMOS</a>
            </div>
                ...
                if (data.data != []) {
                    ...
                    $.each(data.data, function(indexInArray, valueOfElement) {
                        ...
                        $("#all-todo-container").append('<div class="todo-item ' + cont + ' p-3 border-bottom position-relative">' +
                            ...
                            //'<a class="edit dropdown-item" href="javascript:void(0);"><i class="fas fa-eye text-info me-1"></i>Detalle</a>' +
