<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Otros</h3>
            ...
            <div class="card" id="card-content-table">
                <div class="card-body">
                    <div class="d-md-flex no-block align-items-center">
                        <div>
                            <h3 class="card-title">Lista de otras literaturas</h3>
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" id="txt_variedad" value="OTR" name="txt_variedad" class="form-control" placeholder="">
                                </div>
                                <div class="col-lg-8">
