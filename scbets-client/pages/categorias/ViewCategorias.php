<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Categorias y Modalidades</h3>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
                <a href="?scbets-inicio">Home</a>
            </li>
            <li class="breadcrumb-item active">categorias y modalidades</li>
        </ol>
    </div>
...
<script>
    const ajax_auth_object = {
        "ajaxurl": "",
        "routeLink": "Li9zY2JldHMtc2VydmVyL0NvbnRyb2xsZXJDYXRlZ29yaWFzLnBocA==",
                ...
                },
                {
                    ...
                    "mRender": function(o) {
                        return '<a href="#" class="blue" data-a="' + (o._aresx) +
                            ...
                            '" data-c="' + atob(o._dresx) + '"  data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg-updte" id="data-edit">' +
    ...
    $(document).ready(function() {
        ...
        $("#bs-example-modal-lg-updte").on('show.bs.modal', function(event) {
            ...
            var modal = $(this)
            modal.find('.modal-body #upd_tipo').val(button.data('b'));
            modal.find('.modal-body #upd_status').val(button.data('c'));
            ...
            <div class="card" id="card-content-table">
                <div class="card-body" style="position: relative;">
                    <div class="d-md-flex no-block align-items-center">
                        <div>
                            <h3 class="card-title">Lista de Categorias y modalidades</h3>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3 row">
                                <label for="txt_tipo" class="col-sm-4 text-end control-label col-form-label">Categoría o Modalidad*</label>
                                <div class="col-sm-8">
                                    <input type="text" id="txt_tipo" name="txt_tipo" class="form-control" placeholder="Nombre" required />
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="txt_status" class="col-sm-4 text-end control-label col-form-label">Estatus*</label>
                                <div class="col-sm-8">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3 row">
                                <label for="upd_tipo" class="col-sm-4 text-end control-label col-form-label">Categoría o Modalidad*</label>
                                <div class="col-sm-8">
                                    <input type="text" id="upd_tipo" name="upd_tipo" class="form-control" placeholder="categoria o Modalidad" required>
