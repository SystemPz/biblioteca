<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Documentos Recepcionales</h3>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
                <a href="?scbets-inicio=">Home</a>
            </li>
            <li class="breadcrumb-item active">Documentos Recepcionales</li>
        </ol>
    </div>
...
<script>
    const ajax_auth_object = {
        "ajaxurl": "",
        "routeLink": "Li9zY2JldHMtc2VydmVyL0NvbnRyb2xsZXJEb2N1bWVudG9zUmVjZXBjaW9uYWxlcy5waHA=",
                ...
                },
                {
                    ...
                    "mRender": function(o) {
                        return '<a href="#" class="blue" data-a="' + (o._aresx) +
                            ...
                            '" data-i="' + atob(o._kresx) +
                            '" data-j="' + atob(o._mresx) +
                            '" data-k="' + atob(o._nresx) + '"  data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg-updte" id="data-edit">' +
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label for="txt_periodo" class="control-label col-form-label">Periodo*</label>
                                    <input type="text" id="txt_periodo" name="txt_periodo" class="form-control" placeholder="periodo: 2022-2023" required>
                                </div>
                            </div>
                            <div class="row">
                                <!--<div class="col-lg-8">
                                    <label for="txt_lugarFechaEdicion" class="control-label col-form-label">Número de páginas*</label>
                                    <input type="text" id="txt_lugarFechaEdicion" name="txt_lugarFechaEdicion" class="form-control" placeholder="Lugar fecha de edición">
                                </div>-->
                                <div class="col-lg-4">
                                    <label for="txt_NumPagina" class="control-label col-form-label">Número de páginas*</label>
                                    <input type="number" id="txt_NumPagina" name="txt_NumPagina" class="form-control" placeholder="" required>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <label for="txt_categoria" class="control-label col-form-label">Modalidad*</label>
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label for="upd_periodo" class="control-label col-form-label">Periodo*</label>
                                    <input type="text" id="upd_periodo" name="upd_periodo" class="form-control" placeholder="periodo: 2022-2023" required>
                                </div>
                            </div>
                            <div class="row">
                                <!--<div class="col-lg-8">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="number" id="upd_NumPagina" name="upd_NumPagina" class="form-control" placeholder="" required>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <label for="upd_categoria" class="control-label col-form-label">Modalidad*</label>
                                    <select id="upd_categoria" name="upd_categoria" class="form-control txt_categoria" required> </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select id="upd_ubicacion" name="upd_ubicacion" class="form-control txt_ubicacion" required> </select>
                                </div>
                                <div class="col-lg-6">
                                    <label for="upd_status" class="col-sm-3 text-end control-label col-form-label">Estatus*</label>
                                    <select id="upd_status" name="upd_status" class="form-control" required>
                                        <option value=""></option>
                                        <option value="1">Activo</option>
                                        <option value="2">Suspend</option>
                                        <option value="3">Baja</option>
