<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Ubicaciones</h3>
...
<script>
    const ajax_auth_object = {
        "ajaxurl": "",
        "routeLink": "Li9zY2JldHMtc2VydmVyL0NvbnRyb2xsZXJVYmljYWNpb25lcy5waHA=",
...

                {
                    ...
                    "mRender": function(o) {
                        ...
                        if (atob(o._dresx) == 1) {
                            ...
                            s = '<i class="fa fa-circle text-dark"></i> <i>Delete</i>';
                        }
                        return s;
                    }
                },
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            <div class="mb-3 row">
                                <label for="txt_name" class="col-sm-4 text-end control-label col-form-label">Nombre Ubicación*</label>
                                <div class="col-sm-8">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3 row">
                                <label for="upd_name" class="col-sm-4 text-end control-label col-form-label">Nombre Ubicación*</label>
                                <div class="col-sm-8">
                                    <input type="text" id="upd_name" name="upd_name" class="form-control" placeholder="categoria o Modalidad" required>
