<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Enciclopedias</h3>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
                <a href="?scbets-inicio=">Home</a>
            </li>
            <li class="breadcrumb-item active">Enciclopedias</li>
        </ol>
    </div>
            ...
            <div class="card" id="card-content-table">
                <div class="card-body">
                    <div class="d-md-flex no-block align-items-center">
                        <div>
                            <h3 class="card-title">Lista de enciclopedias</h3>
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" id="txt_variedad" value="ENC" name="txt_variedad" class="form-control" placeholder="Folio" />
                                </div>
                                <div class="col-lg-8">
