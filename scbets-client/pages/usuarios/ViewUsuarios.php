...
<script>
    const ajax_auth_object = {
        "ajaxurl": "",
        "routeLink": "Li9zY2JldHMtc2VydmVyL0NvbnRyb2xsZXJVc3Vhcmlvcy5waHA=",
        ...
        table_user = $('#table_user').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "bSortable": false,
                    "mRender": function(o) {
                        return '<a href="#" class="blue" data-a="' + (o._aresx) + '" data-b="' + atob(o._gresx) + '" data-c="' + atob(o._hresx) + '" data-d="' + atob(o._dresx) +
                            '" data-e="' + atob(o._fresx) + '" data-f="' + atob(o._iresx) + '"  data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg-updte" id="data-edit">' +
    ...
    $(document).ready(function() {
        ...
        $("#bs-example-modal-lg-updte").on('show.bs.modal', function(event) {
            ...
            var modal = $(this)
            modal.find('.modal-body #upd_name').val(button.data('b'))
            modal.find('.modal-body #upd_firtsname').val(button.data('c'))
            modal.find('.modal-body #upd_email').val(button.data('d'))
            modal.find('.modal-body #upd_password').val(button.data('e'))
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table id="table_user" class="table table-hover table-striped table-sm mb-0 display nowrap" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Usuario</th>
                                            <th>E-mail</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            ...
                            <div class="mb-3 row">
                                <label for="txt_password" class="col-sm-3 text-end control-label col-form-label">Contraseña*</label>
                                <div class="col-sm-9">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3 row">
                                <label for="upd_password" class="col-sm-3 text-end control-label col-form-label">Contraseña*</label>
                                <div class="col-sm-9">
                                    <input type="password" id="upd_password" name="upd_password" class="form-control" placeholder="Contraseña" required />
                                </div>
                            </div>
                            <div class="mb-3 row">
